Public Class Form1
    ...
    Private Sub Calcular_Click(sender As Object, e As EventArgs) Handles Calcular.Click
        ...
        If (combomarca.Text = "") Then
            ...
            MsgBox("Seleccione la marca de vehículo", vbQuestion)
            Exit Sub
            txtnit.Focus()
        ...
        If (txtplaca.Text = "") Then
            ...
            MsgBox("Ingrese su número de placa", vbQuestion)
            Exit Sub
            txtplaca.Focus()
        ...
        If (txtdias.Text = "") Then
            ...
            MsgBox("Ingrese la cantidad de días que alquilara el vehículo", vbQuestion)
            Exit Sub
            txtdias.Focus()
        ...
        If (indice < 6) Then
            ...
            If checkefectivo.Checked = True And checktarjeta.Checked = False Then
                ...
                If Val(txtefectivo.Text) <> 100 Then
                    ...
                    MsgBox("Error el pago no se puede procesar si no ingresa el 100% de su pago a realizar")
                    Exit Sub

                ElseIf Val(txtefectivo.Text) = 100 Then

                    MsgBox("Descuento aplicado por pagar en efectivo")
            ...
            If checkefectivo.Checked = False And checktarjeta.Checked = True Then
                ...
                ElseIf Val(txttarjeta.Text) = 100 Then
                    ...
                    MsgBox("Recargo aplicado por pagar con tarjeta")
        ...
        If (indice >= 6) Then
            MsgBox("Límite de ingresos alcanzado", vbExclamation, Title:="Sistema:")
        End If
    ...
    Public Function calcularparcial(ByRef PagoParcial As Double) As Double
        ...
        If combomarca.Text = "Honda" Then
            PagoParcial = Hondadia * Val(txtdias.Text)

        ElseIf combomarca.Text = "Mercedes Benz" Then
            PagoParcial = Mercedesdia * Val(txtdias.Text)

        ElseIf combomarca.Text = "Toyota" Then
            PagoParcial = Toyotadia * Val(txtdias.Text)

        ElseIf combomarca.Text = "Mazda" Then
            PagoParcial = Mazdadia * Val(txtdias.Text)
