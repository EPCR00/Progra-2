Module Module1
    ...
    Public Hondadia As Double = 250.0
    Public Mercedesdia As Double = 450.0
    Public Toyotadia As Double = 325.0
    Public Mazdadia As Double = 300.0
    ...
    Sub Limpiar_vectores()
        ...
        indice = 0
        MsgBox("Puede realizar ingresos nuevamente", vbExclamation)
